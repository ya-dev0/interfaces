  ...
  return (
    <div className="mb-12">
      ...
      <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
        Киберпанк — жанр научной фантастики, фокусирующийся на сочетании "низкой жизни" и "высокой технологии". Визуальный стиль характеризуется яркими неоновыми цветами, темными тонами, футуристическими элементами и урбанистическими пейзажами.
      </p>
